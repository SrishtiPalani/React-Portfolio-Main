  ...
  audio.loop = true;
    ...
    style={{ 
      ...
      // paddingBottom: '-15px', 
          ...
          I study how people search, synthesize, and create using large amounts of disparate information. Based on these user insights, I also design, develop, and deploy novel intelligent interactive systems that amplify the human ability to discover, make sense of complex information and be creative!
          <br /> <br /> 
          My doctoral research is supported by the <a href="https://research.google/outreach/phd-fellowship/" target="_blank" rel="noreferrer">Google Ph.D. Fellowship</a> and <a href="https://www.aspirations.org/award-programs/aic-collegiate-award" target="_blank" rel="noreferrer">NCWIT Collegiate Award</a>.
          ...
          <br /> <br /> 
          Outside of research, I am passionate about establishing <a href="#dei">mentorship programs</a> to bridge the gender gap in technology, and 
          <a href="#teaching"> teaching</a> design and computational thinking courses. In my free time, I love playing squash, and exploring new beaches and hiking trails with my puppy.
          </p>
